...
export function Intervals(items){
  ...
  return (
    <div className="relative flex basis-1/12 flex-row items-center h-full w-[1/4]">
      <div className="flex break-words justify-center items-center relative basis-3/5 h-full text-xs lg:max-xl:text-sm xl:max-2xl:text-lg 2xl:text-base intervalNrs text-black font-medium">{items.text}</div>
  ...
  function KeyChoice(items) {
    return (
      <div className={`fixed left-[15%] top-[35%] w-[70%] h-[40%] grid grid-cols-4 bg-slate-400 bg-opacity-20 z-50 rounded-2xl md:invisible`}>
        <div className="hover:bg-blue-700 flex items-center justify-center text-[#929292] text-2xl font-semibold rounded-tl-2xl" onClick={() => {setKey('A'); setKeyChanging(false); setTuningChanging(false); setChordChanging(false); setIntervalChanging(false); setScaleChanging(false); setAccidental("")}}>A</div>
        <div className="hover:bg-blue-700  flex items-center justify-center text-2xl text-[#929292] font-semibold" onClick={() => {setKey('A#'); setKeyChanging(false); setTuningChanging(false); setChordChanging(false); setIntervalChanging(false); setScaleChanging(false);   setAccidental("#")}}>A#</div>
        <div className="hover:bg-blue-700  flex items-center justify-center text-2xl text-[#929292] font-semibold" onClick={() => {setKey('B'); setKeyChanging(false); setTuningChanging(false); setChordChanging(false); setIntervalChanging(false); setScaleChanging(false);   setAccidental("")}}>B</div>
        <div className="hover:bg-blue-700  flex items-center justify-center text-2xl text-[#929292] font-semibold rounded-tr-2xl" onClick={() => {setKey('C'); setKeyChanging(false); setTuningChanging(false); setChordChanging(false); setIntervalChanging(false); setScaleChanging(false);   setAccidental("")}}>C</div>
        <div className="hover:bg-blue-700  flex items-center justify-center text-2xl text-[#929292] font-semibold" onClick={() => {setKey('C#'); setKeyChanging(false); setTuningChanging(false); setChordChanging(false); setIntervalChanging(false); setScaleChanging(false);   setAccidental("#")}}>C#</div>
        <div className="hover:bg-blue-700  flex items-center justify-center text-2xl text-[#929292] font-semibold" onClick={() => {setKey('D'); setKeyChanging(false); setTuningChanging(false); setChordChanging(false); setIntervalChanging(false); setScaleChanging(false);   setAccidental("")}}>D</div>
        <div className="hover:bg-blue-700  flex items-center justify-center text-2xl text-[#929292] font-semibold" onClick={() => {setKey('D#'); setKeyChanging(false); setTuningChanging(false); setChordChanging(false); setIntervalChanging(false); setScaleChanging(false);   setAccidental("#")}}>D#</div>
        <div className="hover:bg-blue-700  flex items-center justify-center text-2xl text-[#929292] font-semibold" onClick={() => {setKey('E'); setKeyChanging(false); setTuningChanging(false); setChordChanging(false); setIntervalChanging(false); setScaleChanging(false);   setAccidental("")}}>E</div>
        <div className="hover:bg-blue-700  flex items-center justify-center text-2xl text-[#929292] font-semibold rounded-bl-2xl" onClick={() => {setKey('F'); setKeyChanging(false); setTuningChanging(false); setChordChanging(false); setIntervalChanging(false); setScaleChanging(false);   setAccidental("")}}>F</div>
        <div className="hover:bg-blue-700  flex items-center justify-center text-2xl text-[#929292] font-semibold" onClick={() => {setKey('F#'); setKeyChanging(false); setTuningChanging(false); setChordChanging(false); setIntervalChanging(false); setScaleChanging(false);  setAccidental("#")}}>F#</div>
        <div className="hover:bg-blue-700  flex items-center justify-center text-2xl text-[#929292] font-semibold" onClick={() => {setKey('G'); setKeyChanging(false); setTuningChanging(false); setChordChanging(false); setIntervalChanging(false); setScaleChanging(false);   setAccidental("")}}>G</div>
        <div className="hover:bg-blue-700  flex items-center justify-center text-2xl text-[#929292] font-semibold rounded-br-2xl" onClick={() => {setKey('G#'); setKeyChanging(false); setTuningChanging(false); setChordChanging(false); setIntervalChanging(false); setScaleChanging(false);   setAccidental("#")}}>G#</div>
      </div>
    );
  }
